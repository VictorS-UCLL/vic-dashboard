// lucide-react v1 removed brand glyphs (Github, Linkedin), so we ship those two
// marks as small inline SVGs. They mirror the lucide API: size via className,
// color via `currentColor`. This keeps us to "no extra icon libraries".
